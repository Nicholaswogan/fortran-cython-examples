...
cdef extern from "module_variable_wrapper.h":
  ...
  cdef void module_variable_get_arr3_size(int32_t *dim1)
  cdef void module_variable_get_arr3(int32_t *dim1, int32_t *var)
  cdef void module_variable_set_arr3(int32_t *dim1, int32_t *var)
